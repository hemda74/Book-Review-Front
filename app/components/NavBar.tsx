...
const NavBar = () => {
  return (
    <>
 <nav className="navbar navbar-expand-lg fixed-top navbar-scroll d-flex align-items-center m-5 ">
  <div className="container d-flex justify-content-between align-items-center ms-auto me-auto  ">
